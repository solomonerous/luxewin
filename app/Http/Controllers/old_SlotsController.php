...
class SlotsController extends Controller
{
    ...
    public function getGameURI(Request $request)
    {
        ...
        $url = "https://test.partners.casinomobule.com/games.start?partner.alias=".($user->admin == 3 ? 'playlucky' : 'playlucky')."&partner.session={$user->api_token}&game.provider={$slot->provider}&game.alias={$slot->alias}&lang=ru&lobby_url=https://new.so-you-start.ru/slots&currency=RUB&mobile=false";
